...
from ..domain.entities import NotificationPreferences as DomainNotificationPreferences
...
class DjangoNotificationRepository(NotificationRepositoryInterface):
    def create(self, notification: DomainNotification) -> DomainNotification:
        django_notification = self._to_django_notification_data(notification)

        created_notification = Notification.objects.create(**django_notification)
        return self._to_domain_notification_data(created_notification)
    ...
    def find_by_id(self, notification_id: str) -> DomainNotification | None:
        try:
            ...
            return self._to_domain_notification_data(django_notification)
    ...
    def get_user_notifications(
        ...
        notifications = [
            self._to_domain_notification_data(notification)
    ...
    def _to_django_notification_data(
    ...
    def _to_domain_notification_data(
        self, django_notification: Notification
    ) -> DomainNotification:
...
class DjangoNotificationPreferencesRepository(
    ...
    def create(
        ...
        django_preferences = self._to_django_preferences_data(preferences)
        ...
        return self._to_domain_preferences_data(created_preferences)
    ...
    def find_by_user(self, user_id: str) -> DomainNotificationPreferences | None:
        try:
            ...
            return self._to_domain_preferences_data(django_preferences)
    ...
    def update(self, preferences: Any, **kwargs) -> DomainNotificationPreferences:
        ...
        preferences.save()
        return self._to_domain_preferences_data(preferences)
    ...
    def _to_django_preferences_data(
        self, domain_preferences: DomainNotificationPreferences
    ) -> Dict[str, Any]:
        return {
    ...
    def _to_domain_preferences_data(
        self, django_preferences: NotificationPreferences
    ) -> DomainNotificationPreferences:
