...
from apps.notifications.domain.entities import Notification, NotificationPreferences
from apps.users.application.ports import (
    ...
    def execute(
        ...
        for follow_relationship in followers:
            try:
                ...
                notification = self.create_notification_rule.execute(notification_dto)
...
class NotifyPostCreatorOfReplyRule:
    ...
    def execute(
        ...
        try:
            ...
            return self.create_notification_rule.execute(notification_dto)
        except ValueError:
...
class GetUserNotificationsRule:
    ...
    def execute(self, dto: NotificationListDTO) -> PaginatedNotificationsResponseDTO:
...
class MarkNotificationsAsReadRule:
    ...
    def execute(self, dto: MarkNotificationsReadDTO) -> None:
...
class GetNotificationPreferencesRule:
    ...
    def execute(self, user_id: str) -> NotificationPreferencesResponseDTO:
